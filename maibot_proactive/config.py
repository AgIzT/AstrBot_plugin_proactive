...
class PluginConfig:
    ...
    def __post_init__(self) -> None:
        ...
        self.group_reply_cooldown_seconds = int(cfg.get("group_reply_cooldown_seconds", 45) or 45)
        self.private_wait_default_seconds = int(cfg.get("private_wait_default_seconds", 5) or 5)
